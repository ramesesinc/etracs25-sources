...
sudo docker rmi -f ramesesinc/etracs25-server-city:255.02.007
...
sudo docker rmi -f ramesesinc/etracs25-server-municipality:255.02.007
...
sudo docker rmi -f ramesesinc/etracs25-server-province:255.02.007
