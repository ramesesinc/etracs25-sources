...
sudo docker build -t ramesesinc/etracs25-server-city:255.02.005 .
cd $RUN_DIR/municipality
sudo docker rmi -f ramesesinc/etracs25-server-municipality:255.02.005
sudo docker build -t ramesesinc/etracs25-server-municipality:255.02.005 .
cd $RUN_DIR/province
sudo docker rmi -f ramesesinc/etracs25-server-province:255.02.005
sudo docker build -t ramesesinc/etracs25-server-province:255.02.005 .
cd ..
echo ""
