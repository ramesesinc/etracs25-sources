...
sudo docker build -t ramesesinc/etracs25-server-city:255.02.004 .
cd $RUN_DIR/municipality
sudo docker rmi -f ramesesinc/etracs25-server-municipality:255.02.004
sudo docker build -t ramesesinc/etracs25-server-municipality:255.02.004 .
cd $RUN_DIR/province
sudo docker rmi -f ramesesinc/etracs25-server-province:255.02.004
sudo docker build -t ramesesinc/etracs25-server-province:255.02.004 .
cd ..
echo ""
