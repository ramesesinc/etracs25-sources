...
docker build -t ramesesinc/etracs25-services:255.01.001 .
cd $RUN_DIR/city
docker rmi -f ramesesinc/etracs25-server-city:255.01.001
docker build -t ramesesinc/etracs25-server-city:255.01.001 .
cd $RUN_DIR/municipality
docker rmi -f ramesesinc/etracs25-server-municipality:255.01.001
docker build -t ramesesinc/etracs25-server-municipality:255.01.001 .
cd $RUN_DIR/province
docker rmi -f ramesesinc/etracs25-server-province:255.01.001
docker build -t ramesesinc/etracs25-server-province:255.01.001 .
cd ..
echo ""
